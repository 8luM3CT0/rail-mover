...
import EzPocketSidebar from '../components/body/for-desktop/ez-pocket/EzPocketSidebar';
//back-end
...
function EzPocketMapDesktop ({
  ...
  const EazeMoMapDesktop = dynamic(() => import("../components/body/for-desktop/eazemo-map/EazeMoMapDesktop"), {
    ssr: false,
  ...
  return (
    <>
      <div
        className='h-full w-full overflow-hidden bg-slate-200 bg-opacity-[0.55]'
      >
        <Head>
          <link
            rel='icon'
        ...
        <main className="w-full h-full border-x-2 border-zinc-800 mx-auto">
          <header className="h-[8%] w-full flex items-center justify-evenly px-3">
            <button 
            onClick={() => {
              setEzRideTab(false)
              setEzWalletTab(true)
            }}
            className="w-[15%] h-[90%] flex items-center justify-center space-x-3 rounded border border-amber-500 bg-slate-800 hover:bg-amber-600 hover:border-slate-900 transform transition-all duration-300 ease-in-out group">
              <WalletIcon 
              className='h-[70%] text-amber-500 group-hover:text-slate-800 transform transition-all duration-300 ease-in-out'
              />
              <p className="font-stack-head font-semibold text-amber-500 text-base group-hover:text-slate-800 transform transition-all duration-300 ease-in-out">
                EZ-Pocket
              </p>
            </button>
            <span className="w-[85%] h-full"></span>
          </header>
          <div className="h-[96%] w-full  overflow-hidden flex items-center space-x-1">
           <EzPocketSidebar onRouteFound={handleRouteFound} onFocusStation={handleFocusStations} />
              <EazeMoMapDesktop 
...
export default EzPocketMapDesktop