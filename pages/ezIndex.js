...
import { EazeMoMapDesktop, MainHeader, MapHeader, MapPageSidebar, SidebarMob } from '../components'
...
import EzPocketSidebarMob from '../components/body/for-desktop/ez-pocket/EzPocketSidebarMob';
//back-end
      ...
      >
        ...
        <main className="w-full h-full border-x-2 border-zinc-800 mx-auto">
          <div className="h-full w-full flex flex-col items-center">
            ...
            <EzPocketSidebarMob onRouteFound={handleRouteFound} onFocusStation={handleFocusStations} />
          </div>
        </main>
          </div>
    {adminPriv && (
