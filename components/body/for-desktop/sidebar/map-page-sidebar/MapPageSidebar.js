...
function MapPageSidebar({onFocusStation, onRouteFound, subscribeModal, setSubscribeModal}) {
...
const km = (a, b) => {
 ...
 const normalizeStation = (raw) => {
    ...
    const lineIdRaw = raw.lineId ?? raw.lineID ?? ""
    const lineId = String(lineIdRaw || "").toLowerCase()
