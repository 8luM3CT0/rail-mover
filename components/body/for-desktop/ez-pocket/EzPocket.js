...
function EzPocket({confirmModal, setConfirmModal, ezPocketModal, setEzPocketModal, setEzPocketMap, ezPocketMap}) {
  ...
  return (
    <>
     <div className="h-[87%] w-full rounded-xl flex flex-col items-start">
            <header className="h-[75px] flex items-center w-full bg-slate-100 px-3 py-1 border-2 border-slate-800 rounded-t-3xl">
              ...
              <div className="h-[42.5%] w-[92%] mx-auto bg-yellow-400 rounded-3xl border border-slate-800">
                ...
                <body className="h-[62%] w-[95%] mx-auto flex flex-col items-center px-3 py-1 space-y-4 overflow-y-scroll scrollbar-thin scrollbar-track-slate-900 scrollbar-thumb-amber-300">
