...
export default function EazeMoMap({ routeCoords=[], endpoints=null, focusPoint=null, allCoords=[], lines={} }) {
...
// --- ONLY-LRT2 FIX HELPERS (bounds + swap + sorting) ---
  ...
  return (
    <div className="h-full w-[90%] m-auto">
          <MapContainer center={safeCenter} zoom={12.30} className="h-full w-full z-0">
      <Fit />
